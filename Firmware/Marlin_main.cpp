...
#ifdef DEBUG_SILENTMODE
	SERIAL_ECHOPAIR("#debug_silentmode Silent mode read from epeprom: ", (unsigned long)silentMode);
#endif
...
#ifdef DEBUG_SILENTMODE
	SERIAL_ECHOPAIR("#debug_silentmode setup - tmc2130_mode: ", (unsigned long)tmc2130_mode);
#endif
	update_mode_profile();
...
#ifdef DEBUG_SILENTMODE
		SERIAL_ECHOPAIR("#debug_silentmode force_high_power_mode - tmc2130_mode: ", (unsigned long)tmc2130_mode);
#endif
		update_mode_profile();
...
#ifdef DEBUG_SILENTMODE
		SERIAL_ECHOPAIR("#debug_silentmode M915 - tmc2130_mode: ", (unsigned long)tmc2130_mode);
#endif
		update_mode_profile();
		tmc2130_init(TMCInitParams(false, FarmOrUserECool()));
    }
...
void disable_force_z()
{
    ...
    tmc2130_mode=TMC2130_MODE_SILENT;
#ifdef DEBUG_SILENTMODE
    SERIAL_ECHOPAIR("#debug_silentmode disable_force_z - tmc2130_mode: ", (unsigned long)tmc2130_mode);
#endif
    update_mode_profile();
...
#ifdef DEBUG_SILENTMODE
SERIAL_ECHOPAIR("#debug_silentmode enable_force_z - tmc2130_mode: ", (unsigned long)tmc2130_mode);
#endif
update_mode_profile();
tmc2130_init(TMCInitParams(true, FarmOrUserECool()));
#endif // TMC2130
